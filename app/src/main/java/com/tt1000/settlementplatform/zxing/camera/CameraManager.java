...
package com.tt1000.settlementplatform.zxing.camera;
...
public final class CameraManager {
	...
	public void requestAutoFocus(Handler handler, int message) {
		if (camera != null && previewing) {
			...
			//FH100H-A is continues autofocus
			//camera.autoFocus(autoFocusCallback);
		}
	}

	/**
	 * Calculates the framing rect which the UI should draw to show the member
	 * where to place the barcode. This target helps with alignment as well as
	 * forces the member to hold the device far enough away to ensure the image
	 * will be in focus.
	 * 
