...
public final class Intents {
  ...
  public static final class Scan {
     ...
     * intent.getStringExtra(RESULT). If the member presses Back, the result code will be
     * RESULT_CANCELED.
     */
  ...
  public static final class Share {
    /**
     * Give the member a choice of items to encode as a barcode, then render it as a QR Code and
