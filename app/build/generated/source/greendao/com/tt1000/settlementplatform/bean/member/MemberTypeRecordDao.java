...
/** 
 * DAO for table "MEMBER_TYPE_RECORD".
*/
public class MemberTypeRecordDao extends AbstractDao<MemberTypeRecord, String> {

    public static final String TABLENAME = "MEMBER_TYPE_RECORD";

    /**
     * Properties of entity MemberTypeRecord.<br/>
    ...
    public static class Properties {
        ...
        public final static Property DISCOUNT_RATE = new Property(10, String.class, "DISCOUNT_RATE", false, "DISCOUNT_RATE");
        public final static Property CODE = new Property(11, String.class, "CODE", false, "CODE");
    }


    public MemberTypeRecordDao(DaoConfig config) {
        super(config);
    }
    
    public MemberTypeRecordDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MEMBER_TYPE_RECORD\" (" + //
                ...
                "\"SORT\" TEXT," + // 8: SORT
                "\"T_ID\" TEXT," + // 9: T_ID
                "\"DISCOUNT_RATE\" TEXT," + // 10: DISCOUNT_RATE
                "\"CODE\" TEXT);"); // 11: CODE
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MEMBER_TYPE_RECORD\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, MemberTypeRecord entity) {
        stmt.clearBindings();
        ...
        String DISCOUNT_RATE = entity.getDISCOUNT_RATE();
        if (DISCOUNT_RATE != null) {
            stmt.bindString(11, DISCOUNT_RATE);
        }
 
        String CODE = entity.getCODE();
        if (CODE != null) {
            stmt.bindString(12, CODE);
        }
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, MemberTypeRecord entity) {
        stmt.clearBindings();
    ...
    @Override
    public MemberTypeRecord readEntity(Cursor cursor, int offset) {
        MemberTypeRecord entity = new MemberTypeRecord( //
            ...
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // DISCOUNT_RATE
            cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11) // CODE
        );
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, MemberTypeRecord entity, int offset) {
        ...
        entity.setDISCOUNT_RATE(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
        entity.setCODE(cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11));
     }
    
    @Override
    protected final String updateKeyAfterInsert(MemberTypeRecord entity, long rowId) {
        return entity.getSEQNO();
    }
    
    @Override
    public String getKey(MemberTypeRecord entity) {
        if(entity != null) {
            return entity.getSEQNO();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(MemberTypeRecord entity) {
